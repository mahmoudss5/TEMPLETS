...
#define adl3_elgandophly ios_base::sync_with_stdio(0);cin.tie(0);
#define vint(v, n) vector<int>v(n)
#define allin(v) for(auto &i : v)cin>>i
#define all(v) v.begin(), v.end()
#define sint(st) set<int>st;
#define sll(st)  set<long long>st;
#define nl '\n'
#define endl '\n'
...
//s.find(ss)!=string::npos  لو عايز تشوف صب استرينج موجود في الاسترينج ولا
// sort(p.begin(), p.end(), [](const std::pair<int, int>& a, const std::pair<int, int>& b) {
//return a.second > b.second;
//});
// int count_of_ones = std::count(vec.begin(), vec.end(), 1);
//                   EMTA HKON GOOD ENOUGH???                                                               //
// (* If the path to what you want seems too easy, then you are at the wrong path.*)

//                  the real code                                                          //const int maxn = 1e5 + 5;
// let them here :
///////////////////////////////////////////////////////////////////////////////////////
int dx[] = {1, 0, -1, 0};
int dy[] = {0, 1, 0, -1};
char di[] = {'D', 'L', 'U', 'R'};
/*
❥❁『أَتْعَبْ قَدُمَاَكْ 』ڣَاَنْ تَعْبَا قَدُمَاَكْ❁
*/
ll MOD = 1e9 + 7;
const int N = 2001;
const long long INF = 1e18;
const int MAXN = 1000;
vector<int> adj[MAXN]; // for graph
void TC() {
